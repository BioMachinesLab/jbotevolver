...
public class NEATMultipleSamplePostEvaluationTask extends JBotEvolverTask {
	...
	public NEATMultipleSamplePostEvaluationTask(int run, int generation, JBotEvolver jBotEvolver, int fitnesssample,
	...
	public Result getResult() {
		NEATPostEvaluationResult fr = new NEATPostEvaluationResult(getId(),run, generation, fitnesssample, fitness,
				startSample);
		return fr;
	}
