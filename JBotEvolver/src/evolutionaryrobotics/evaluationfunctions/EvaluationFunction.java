...
public abstract class EvaluationFunction implements Serializable, Updatable {
	private static final long serialVersionUID = -3895531956415747801L;
	protected double fitness;
	protected MetricsData metricsData;
	protected Arguments arguments;
	protected boolean collectMetrics = false;

	public EvaluationFunction(Arguments arguments) {
	...
	public static EvaluationFunction getEvaluationFunction(Arguments arguments) {
		...
		try {
			...
			// NEAT needs to instantiate EvalFunctions locally, so it is
			// Necessary to check this if we are using Conillon...
