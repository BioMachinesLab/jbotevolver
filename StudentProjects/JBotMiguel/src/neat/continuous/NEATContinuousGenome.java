...
public class NEATContinuousGenome extends NEATGenome implements Cloneable, Serializable {
	 ...
	 */
	protected final List<NEATLinkGene> linksList = new ArrayList<NEATLinkGene>();
	 ...
	 */
	protected final List<NEATNeuronGene> neuronsList = new ArrayList<NEATNeuronGene>();
	...
	public int getNumGenes() {
		return this.linksList.size() + this.neuronsList.size();
	}
