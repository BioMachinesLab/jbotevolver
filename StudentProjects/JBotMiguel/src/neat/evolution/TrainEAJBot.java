...
public class TrainEAJBot extends BasicEAJBot implements MLTrain {
	 ...
	 */
	public TrainEAJBot(Population thePopulation, CalculateScore theScoreFunction) {
	 ...
	 */
	public TrainEAJBot(Population thePopulation, MLDataSet trainingData) {
