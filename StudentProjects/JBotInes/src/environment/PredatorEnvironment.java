...
public class PredatorEnvironment extends Environment{
	...
	private Robot predator;
	
	private Simulator simulator;

	public PredatorEnvironment(Simulator simulator, Arguments arguments) {
	...
	public void setup(Simulator simulator) {
		...
		predator = Robot.getRobot(simulator, args);
		predator.setController(new RunawayController(simulator, predator, args));
		predator.setPosition(2, 2);
		predator.setBodyColor(Color.RED);
		addRobot(predator);
