...
public class SingleClusterPatrollingEvaluationFunction2 extends EvaluationFunction{
	...
	public SingleClusterPatrollingEvaluationFunction2(Arguments args) {
		super(args);
	...
	public void update(Simulator simulator) {
		...
		// painting radius is 1/2 sensor radius max
		// starts at zero and increases when a robot joins the cluster
