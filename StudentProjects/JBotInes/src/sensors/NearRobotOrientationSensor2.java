...
public class NearRobotOrientationSensor2 extends Sensor{
	...
	public NearRobotOrientationSensor2(Simulator simulator,int id, Robot robot, Arguments args) {
	...
	public double getSensorReading(int sensorNumber) {
		...
		double diff = near.getOrientation()-robot.getOrientation();
		...
		return diff/2/Math.PI+0.5;
				//near.getPosition().getAngle()/Math.PI;
