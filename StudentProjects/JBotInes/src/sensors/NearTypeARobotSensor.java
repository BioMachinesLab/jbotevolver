...
public class NearTypeARobotSensor extends Sensor {
	...
	public NearTypeARobotSensor(Simulator simulator,int id, Robot robot, Arguments args) {
	...
	public double getSensorReading(int sensorNumber) {
		...
		for(Robot r : robots) {
			if(r.getPosition().distanceTo(this.robot.getPosition()) < range && this.robot.getId() != r.getId() && r.getDescription().equals(ID_DESCRIPTION)) {
				value = 1;
				break;
			}
		}
