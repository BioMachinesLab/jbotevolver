...
public class FieldTestLogParser {
	...
	public FieldTestLogParser(File folder, String[] descriptions) throws Exception {
		boolean readCompleteFiles = false;

		for (String s : descriptions) {
			String file = folder.getAbsolutePath() + "/" + s;
	...
	private void populateCompleteLogs(File folder, int[] robots) throws IOException {
		for (int i : robots) {
			String file = folder.getAbsolutePath()+ "/onboard/" + i;
