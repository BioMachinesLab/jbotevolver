...
import environment.ConsumingPreyEnvironment;
...
public class ConsumingPreyEvaluationFunction extends EvaluationFunction{
	...
	public ConsumingPreyEvaluationFunction(Arguments args) {
		super(args);	
	}
	...
	public void update(Simulator simulator) {	
		ConsumingPreyEnvironment environment= ((ConsumingPreyEnvironment)(simulator.getEnvironment()));
