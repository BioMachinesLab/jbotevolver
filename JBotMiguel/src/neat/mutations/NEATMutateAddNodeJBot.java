...
public class NEATMutateAddNodeJBot extends NEATMutateAddNode implements Serializable {
	...
	public void performOperation(final Random rnd, final Genome[] parents,
		...
		/**
		 * Changed here (rnd instead of new Random())
		 * @miguelduarte42
		 */
		final ActivationFunction af = ((NEATPopulation)getOwner().getPopulation())
				.getActivationFunctions().pick(new Random(rnd.nextLong()));
