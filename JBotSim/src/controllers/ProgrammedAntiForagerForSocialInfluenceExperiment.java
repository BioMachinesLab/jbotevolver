...
public class ProgrammedAntiForagerForSocialInfluenceExperiment extends
	...
	public ProgrammedAntiForagerForSocialInfluenceExperiment(
		...
		grabLimit = (range - .75 * ((RoundForageEnvironment) simulator
				.getEnvironment()).getForageRadius()) / range;
	}
