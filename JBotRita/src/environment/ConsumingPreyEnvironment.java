...
public class ConsumingPreyEnvironment extends Environment {
	...
	// SimplestEnvironment  fitnesssample==0
	...
	// EasyEnvironment fitnesssample==1
	...
	// MeddiumEnvironment fitnesssample==2
	...
	// DifficultEnvironment fitnesssample==3
	...
	public ConsumingPreyEnvironment(Simulator simulator, Arguments arguments) {
	...
	public void setup(Simulator simulator) {
		...
		//if(isToTestAllEnv!=false){
			if (fitnesssample == 0) {
				...
				addStaticObject(new Wall(simulator, 0, 0, 0.1, 3.8)); //west wall
			} else {
	...
	private Vector2d newRandomPositionEasyEnvironment() {
		return newRandomPosition(MAX_X_LIMIT_FOR_PREY_WESTWALL_EASYENV , MIN_X_LIMIT_FOR_PREY_WESTWALL_EASYENV 
		, MAX_Y_LIMIT_FOR_PREY_WESTWALL_EASYENV, MIN_Y_LIMIT_FOR_PREY_WESTWALL_EASYENV ,
	...
	private Vector2d newRandomPositionMeddiumEnvironment() {
		return newRandomPosition(
				MAX_X_LIMIT_FOR_PREY_EASTNORTHWALL_MEDDIUMENV,
				...
				MIN_Y_LIMIT_FOR_PREY_EASTSOUTHWALL_MEDDIUMENV, MAX_X_LIMIT_FOR_PREY_WESTNORTHWALL_MEDDIUMENV,
