...
public class MazeDifficultEvaluation extends EvaluationFunction{
	...
	public MazeDifficultEvaluation(Arguments args) {
		super(args);	
	}
	...
	public void update(Simulator simulator) {	
		MazeDifficultEnvironment environment= ((MazeDifficultEnvironment)(simulator.getEnvironment()));
