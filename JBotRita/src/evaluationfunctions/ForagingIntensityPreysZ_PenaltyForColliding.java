...
import environments_ForagingIntensityPreysWallsWithZ.ForagingIntensityPreysEnvironment_Z;
import evolutionaryrobotics.evaluationfunctions.EvaluationFunction;

public class ForagingIntensityPreysZ_PenaltyForColliding  extends EvaluationFunction{
	...
	public ForagingIntensityPreysZ_PenaltyForColliding(Arguments args) {
		super(args);	
	}
	...
	//	Consuming1Environment environment= ((Consuming1Environment)(simulator.getEnvironment()));
		ForagingIntensityPreysEnvironment_Z environment= ((ForagingIntensityPreysEnvironment_Z)(simulator.getEnvironment()));
...
//				
				if(r.isInvolvedInCollisonWall()){
					    // put numberOfFood inside FirstIf
						current-=0.01;
				}
