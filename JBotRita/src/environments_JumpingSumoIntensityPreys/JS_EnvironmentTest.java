...
public class JS_EnvironmentTest extends JS_Environment {
	...
	public JS_EnvironmentTest(Simulator simulator, Arguments arguments) {
	...
	public void init(Environment env) {
		...
		double width = random.nextDouble()*(2.2-0.5)+0.5;
