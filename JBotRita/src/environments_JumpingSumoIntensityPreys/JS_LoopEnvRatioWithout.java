...
public class JS_LoopEnvRatioWithout extends JS_Environment {
	...
	private JS_EnvRatio2_5 ratio2_5;
	private JS_EnvRatio3 ratio3;
	private JS_EnvWithoutRatio withoutRatio;

	public JS_LoopEnvRatioWithout(Simulator simulator, Arguments arguments) {
	...
	public void setup(Simulator simulator) {
		...
		if (fitnesssample == 0) {
			...
			ratio2_5 = new JS_EnvRatio2_5(simulator, args);
