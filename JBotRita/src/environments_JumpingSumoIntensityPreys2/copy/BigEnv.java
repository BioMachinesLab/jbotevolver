...
public class BigEnv extends JS_Environment {  //RATIO2
...
//	
	private static final double MAX_WIDTH_LIMIT_FOR_WALL = 33;//4
	private static final double MIN_WIDTH_LIMIT_FOR_WALL =28; //2.6
...
//	private double random1, random2;
	...
	public BigEnv(Simulator simulator, Arguments arguments) {
...
//				+ random1;
		...
		env.addStaticObject(new Wall(simulator, 0, 0, b * 2 - 0.8, 0.4)); //centerWall
	
		env.addPrey(new IntensityPrey(simulator, "Prey " + 0, new Vector2d(0, a), 0, PREY_MASS, 0.125, 1));
