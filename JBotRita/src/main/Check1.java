...
public class Check1 {
	...
	static String name="tese40_ReynoldsLocally";
	...
	public static void main(String[] args) throws Exception{
		...
		String[] setups = new String[]{f+"ReynoldsLocally/3/"};
		...
		for(int fitnesssample = 0 ; fitnesssample < fitnesssamples ; fitnesssample++) {
			...
			for(int i = 0 ; i < samples ; i++) {
				...
				*/
				...
				System.out.println(split[split.length - 2]+"\t"+split[split.length - 1]+"\t"+fitnesssample+"\t"+i+"\t"+eval[0].getFitness());
