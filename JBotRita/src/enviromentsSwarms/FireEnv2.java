...
public class FireEnv2 extends JS_Environment {
...
//	private static final double MIN_WIDTH_LIMIT_FOR_WALL = 3.875; //3.1
	...
	private int numberOfWallsHorizontal=4;
	private int numberOfWallsVertical=2;
	private Environment env;
	private double ratio;
	private double intensityOfPrey=0.0;
	

	public FireEnv2(Simulator simulator, Arguments arguments) {
	...
	public void init() {
		...
		double rangeBetweenWalls=WIDTH_HEIGHT_WALLSURRONDED/(numberOfWalls);
		
//		for(int i=0; i<numberOfWallsHorizontal; i++){
