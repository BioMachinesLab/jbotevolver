...
public class MeddiumEnv_WallsH extends ForagingIntensityPreysEnvironment {
	...
	private static final double MAX_Y_LIMIT_FOR_PREY_TOP_DIFFICULTENV = 0.6;
	...
	private static final double MIN_Y_LIMIT_FOR_PREY_BOTTOM_DIFFICULTENV = -0.6;
	private boolean firstPositionOfPreyWasAdded =false;
	
	
	
	public MeddiumEnv_WallsH(Simulator simulator, Arguments arguments) {
