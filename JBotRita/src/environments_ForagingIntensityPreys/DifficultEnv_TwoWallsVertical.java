...
public class DifficultEnv_TwoWallsVertical extends ForagingIntensityPreysEnvironment {
	private static final double MAX_X_LIMIT_FOR_PREY_TOP_DIFFICULTENV = 1.3;
	private static final double MIN_X_LIMIT_FOR_PREY_TOP_DIFFICULTENV = 0.8;
	...
	public DifficultEnv_TwoWallsVertical(Simulator simulator, Arguments arguments) {
