...
public class DifficultEnv_TwoWallsHorizontal extends ForagingIntensityPreysEnvironment {
	...
	public DifficultEnv_TwoWallsHorizontal(Simulator simulator, Arguments arguments) {
