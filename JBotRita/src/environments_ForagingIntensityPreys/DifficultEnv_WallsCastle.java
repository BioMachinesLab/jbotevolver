...
public class DifficultEnv_WallsCastle extends ForagingIntensityPreysEnvironment {
	...
	public DifficultEnv_WallsCastle(Simulator simulator, Arguments arguments) {
