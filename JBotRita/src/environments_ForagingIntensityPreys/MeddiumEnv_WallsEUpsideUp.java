...
public class MeddiumEnv_WallsEUpsideUp extends ForagingIntensityPreysEnvironment {
	...
	public MeddiumEnv_WallsEUpsideUp(Simulator simulator, Arguments arguments) {
