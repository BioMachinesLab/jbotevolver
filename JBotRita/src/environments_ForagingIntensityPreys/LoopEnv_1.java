...
public class LoopEnv_1 extends ForagingIntensityPreysEnvironment {
	...
	private MeddiumEnv_WallsTwoCrosses meddiumEnv;
	private DifficultEnv_HalfSquare difficultEnv;

	public LoopEnv_1(Simulator simulator, Arguments arguments) {
	...
	public void setup(Simulator simulator) {
		...
		if (fitnesssample == 0) {
			...
			meddiumEnv = new MeddiumEnv_WallsTwoCrosses(simulator, args);
			meddiumEnv.setup(this, simulator);
		} else {
			difficultEnv = new DifficultEnv_HalfSquare(simulator, args);
