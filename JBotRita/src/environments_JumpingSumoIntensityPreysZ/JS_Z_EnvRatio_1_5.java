...
public class JS_Z_EnvRatio_1_5 extends JS_Environment {
	...
	public JS_Z_EnvRatio_1_5(Simulator simulator, Arguments arguments) {
	...
	public void init() {
		...
		env.addPrey(new IntensityPrey(simulator, "Prey " + 0, new Vector2d(0, a), 0, PREY_MASS, PREY_RADIUS, randomIntensity()));
