...
public class DifficultEnv_WallsZ_Hat extends ForagingIntensityPreysEnvironment_Z {
	...
	public DifficultEnv_WallsZ_Hat(Simulator simulator, Arguments arguments) {
