...
public class MeddiumEnv_WallsZ_H_Horizontal extends ForagingIntensityPreysEnvironment_Z {
	...
	public MeddiumEnv_WallsZ_H_Horizontal(Simulator simulator, Arguments arguments) {
