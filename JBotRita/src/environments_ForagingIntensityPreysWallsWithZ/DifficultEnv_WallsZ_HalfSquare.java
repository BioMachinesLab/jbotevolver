...
public class DifficultEnv_WallsZ_HalfSquare extends ForagingIntensityPreysEnvironment_Z {
	...
	public DifficultEnv_WallsZ_HalfSquare(Simulator simulator, Arguments arguments) {
