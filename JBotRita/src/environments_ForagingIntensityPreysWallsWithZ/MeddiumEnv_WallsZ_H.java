...
public class MeddiumEnv_WallsZ_H extends ForagingIntensityPreysEnvironment_Z {
	private static final double MAX_X_LIMIT_FOR_PREY_TOP_DIFFICULTENV = 0.5;
	private static final double MIN_X_LIMIT_FOR_PREY_TOP_DIFFICULTENV = -0.5;
	private static final double MAX_Y_LIMIT_FOR_PREY_TOP_DIFFICULTENV = 0.7;
	private static final double MIN_Y_LIMIT_FOR_PREY_TOP_DIFFICULTENV = 0.5;

	private static final double MAX_X_LIMIT_FOR_PREY_BOTTOM_DIFFICULTENV = 0.5;
	private static final double MIN_X_LIMIT_FOR_PREY_BOTTOM_DIFFICULTENV = -0.5;
	private static final double MAX_Y_LIMIT_FOR_PREY_BOTTOM_DIFFICULTENV = -0.5;
	private static final double MIN_Y_LIMIT_FOR_PREY_BOTTOM_DIFFICULTENV = -0.8;
	private boolean firstPositionOfPreyWasAdded =false;
	
	
	
	public MeddiumEnv_WallsZ_H(Simulator simulator, Arguments arguments) {
