...
public class MeddiumEnv_WallsZ_TwoCrosses extends ForagingIntensityPreysEnvironment_Z {
	...
	public MeddiumEnv_WallsZ_TwoCrosses(Simulator simulator, Arguments arguments) {
