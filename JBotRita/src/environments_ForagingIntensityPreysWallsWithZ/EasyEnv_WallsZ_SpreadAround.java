...
public class EasyEnv_WallsZ_SpreadAround extends ForagingIntensityPreysEnvironment_Z {
	...
	public EasyEnv_WallsZ_SpreadAround(Simulator simulator, Arguments arguments) {
