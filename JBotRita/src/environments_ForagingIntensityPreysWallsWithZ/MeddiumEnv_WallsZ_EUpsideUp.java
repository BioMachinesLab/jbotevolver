...
public class MeddiumEnv_WallsZ_EUpsideUp extends ForagingIntensityPreysEnvironment_Z {
	...
	private static final double MAX_Y_LIMIT_FOR_PREY_RIGHT_DIFFICULTENV = -1.5;
	...
	private static final double MAX_Y_LIMIT_FOR_PREY_LEFT_DIFFICULTENV = -1.5;
	private static final double MIN_Y_LIMIT_FOR_PREY_LEFT_DIFFICULTENV =-1.7;
	private boolean firstPositionOfPreyWasAdded =false;
	
	
	
	public MeddiumEnv_WallsZ_EUpsideUp(Simulator simulator, Arguments arguments) {
