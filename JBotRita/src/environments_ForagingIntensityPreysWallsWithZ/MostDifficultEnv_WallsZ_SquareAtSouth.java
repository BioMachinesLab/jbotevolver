...
public class MostDifficultEnv_WallsZ_SquareAtSouth extends ForagingIntensityPreysEnvironment_Z {
	// MostDifficultEnvironment =4
		private static final double MAX_X_LIMIT_FOR_PREY_WESTWALL_MOSTDIFFICULTMENV = -2.2;
		private static final double MIN_X_LIMIT_FOR_PREY_WESTWALL_MOSTDIFFICULTMENV = -2;
		...
		private static final double MAX_X_LIMIT_FOR_PREY_EASTWALL_MOSTDIFFICULTMENV = 1;
		private static final double MIN_X_LIMIT_FOR_PREY_EASTWALL_MOSTDIFFICULTMENV = 0.7;
		...
		private static final double MAX_Y_LIMIT_FOR_PREY_NORTHWALL_MOSTDIFFICULTMENV = 1;
		private static final double MIN_Y_LIMIT_FOR_PREY_NORTHWALL_MOSTDIFFICULTMENV = 0.7;
		...
		private static final double MAX_Y_LIMIT_FOR_PREY_SOUTHWALL_MOSTDIFFICULTMENV = -2;
		private static final double MIN_Y_LIMIT_FOR_PREY_SOUTHWALL_MOSTDIFFICULTMENV = -2.2;

		private static final double MAX_X_LIMIT_FOR_PREY_INSIDEWALL_MOSTDIFFICULTMENV = -0.3;
		private static final double MIN_X_LIMIT_FOR_PREY_INSIDEWALL_MOSTDIFFICULTMENV = -1;
		private static final double MAX_Y_LIMIT_FOR_PREY_INSIDEWALL_MOSTDIFFICULTMENV = -0.2;
		private static final double MIN_Y_LIMIT_FOR_PREY_INSIDEWALL_MOSTDIFFICULTMENV = -1.1;
		private boolean firstPositionOfPreyWasAdded =false;
	
	
	
	public MostDifficultEnv_WallsZ_SquareAtSouth(Simulator simulator, Arguments arguments) {
