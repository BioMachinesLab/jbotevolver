...
public class DifficultEnv_WallsZ_TwoWallsHorizontal extends ForagingIntensityPreysEnvironment_Z {
	private static final double MAX_X_LIMIT_FOR_PREY_TOP_DIFFICULTENV = 1.7;
	private static final double MIN_X_LIMIT_FOR_PREY_TOP_DIFFICULTENV = 1.3;
	private static final double MAX_Y_LIMIT_FOR_PREY_TOP_DIFFICULTENV = 1.5;
	private static final double MIN_Y_LIMIT_FOR_PREY_TOP_DIFFICULTENV = 1;

	private static final double MAX_X_LIMIT_FOR_PREY_BOTTOM_DIFFICULTENV = -1.5;
	...
	private static final double MIN_Y_LIMIT_FOR_PREY_BOTTOM_DIFFICULTENV = -0.9;
	private boolean firstPositionOfPreyWasAdded =false;
	
	public DifficultEnv_WallsZ_TwoWallsHorizontal(Simulator simulator, Arguments arguments) {
	...
	public void init(Environment env){   		
        ...
        env.addStaticObject(new Wall(simulator, 0.4, 0.8, 3.3, 0.1)); //id=2 vertical right (close to the id==1)					
        env.addStaticObject(new Wall(simulator, -0.4, -0.4, 3.3, 0.1)); //id=2 vertical right (close to the id==1)					
