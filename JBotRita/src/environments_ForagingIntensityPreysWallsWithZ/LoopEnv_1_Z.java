...
public class LoopEnv_1_Z extends ForagingIntensityPreysEnvironment_Z {
	...
	private MeddiumEnv_WallsZ_H easyEnv;
	private MeddiumEnv_WallsZ_4HalfSquareHorizontal meddiumEnv;
	private DifficultEnv_WallsZ_Mazze difficultEnv;
	private DifficultEnv_WallsZ_TwoWallsVertical mostDifficultEnv;

	public LoopEnv_1_Z(Simulator simulator, Arguments arguments) {
	...
	public void setup(Simulator simulator) {
		...
		if (fitnesssample == 0) {
			...
			easyEnv = new MeddiumEnv_WallsZ_H(simulator, args);
			easyEnv.setup(this, simulator);
		} else if (fitnesssample == 2) {
			meddiumEnv = new MeddiumEnv_WallsZ_4HalfSquareHorizontal(simulator, args);
			...
			mostDifficultEnv = new DifficultEnv_WallsZ_TwoWallsVertical(simulator, args);
