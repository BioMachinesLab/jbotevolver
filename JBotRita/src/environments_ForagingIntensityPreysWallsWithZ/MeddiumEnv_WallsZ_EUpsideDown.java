...
public class MeddiumEnv_WallsZ_EUpsideDown extends ForagingIntensityPreysEnvironment_Z {
	...
	private static final double MAX_Y_LIMIT_FOR_PREY_RIGHT_DIFFICULTENV = 1.7;
	private static final double MIN_Y_LIMIT_FOR_PREY_RIGHT_DIFFICULTENV = 1.5;
	...
	private static final double MAX_Y_LIMIT_FOR_PREY_LEFT_DIFFICULTENV = 1.7;
	private static final double MIN_Y_LIMIT_FOR_PREY_LEFT_DIFFICULTENV =1.5;
	private boolean firstPositionOfPreyWasAdded =false;
	
	
	
	public MeddiumEnv_WallsZ_EUpsideDown(Simulator simulator, Arguments arguments) {
	...
	public void init(Environment env){   		
        ...
        env.addStaticObject(new Wall(simulator, 0, 0, 0.1, 4)); // vertical center
