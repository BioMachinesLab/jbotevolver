...
public class DifficultEnv_WallsZ_TwoWallsVertical extends ForagingIntensityPreysEnvironment_Z {
	private static final double MAX_X_LIMIT_FOR_PREY_TOP_DIFFICULTENV = 1.3;
	private static final double MIN_X_LIMIT_FOR_PREY_TOP_DIFFICULTENV = 0.9;
	private static final double MAX_Y_LIMIT_FOR_PREY_TOP_DIFFICULTENV = 0.3;
	private static final double MIN_Y_LIMIT_FOR_PREY_TOP_DIFFICULTENV = -0.5;

	private static final double MAX_X_LIMIT_FOR_PREY_BOTTOM_DIFFICULTENV = -1.4;
	private static final double MIN_X_LIMIT_FOR_PREY_BOTTOM_DIFFICULTENV = -1.6;
	private static final double MAX_Y_LIMIT_FOR_PREY_BOTTOM_DIFFICULTENV = -0.5;
	private static final double MIN_Y_LIMIT_FOR_PREY_BOTTOM_DIFFICULTENV = -0.1;
	private boolean firstPositionOfPreyWasAdded =false;
	
	
	
	public DifficultEnv_WallsZ_TwoWallsVertical(Simulator simulator, Arguments arguments) {
