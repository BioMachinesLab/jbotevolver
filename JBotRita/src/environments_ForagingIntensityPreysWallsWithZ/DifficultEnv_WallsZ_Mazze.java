...
public class DifficultEnv_WallsZ_Mazze extends ForagingIntensityPreysEnvironment_Z {
	// DifficultEnvironment=3
	private static final double MAX_X_LIMIT_FOR_PREY_NORTH_DIFFICULTENV = -0.6;
	private static final double MIN_X_LIMIT_FOR_PREY_NORTH_DIFFICULTENV = 0.4;
	private static final double MAX_Y_LIMIT_FOR_PREY_NORTH_DIFFICULTENV = 0.3;
	private static final double MIN_Y_LIMIT_FOR_PREY_NORTH_DIFFICULTENV = -0.4;

	private static final double MAX_X_LIMIT_FOR_PREY_SOUTH_DIFFICULTENV = -1.3;
	private static final double MIN_X_LIMIT_FOR_PREY_SOUTH_DIFFICULTENV = -1.5;
	...
	public DifficultEnv_WallsZ_Mazze(Simulator simulator, Arguments arguments) {
