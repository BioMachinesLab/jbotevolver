...
public class DifficultEnv_WallsZ_HalfSquareUpsideDown extends ForagingIntensityPreysEnvironment_Z {
	...
	public DifficultEnv_WallsZ_HalfSquareUpsideDown(Simulator simulator, Arguments arguments) {
