...
public class MeddiumEnv_WallsZ_Cross extends ForagingIntensityPreysEnvironment_Z {
	...
	public MeddiumEnv_WallsZ_Cross(Simulator simulator, Arguments arguments) {
	...
	public void init(Environment env){   		
		...
		env.addStaticObject(new Wall(simulator, 0, 0, 3.8, 0.1)); //horizontal wall
		env.addStaticObject(new Wall(simulator, 0, 0, 0.1, 3.8));  //vertical wall
