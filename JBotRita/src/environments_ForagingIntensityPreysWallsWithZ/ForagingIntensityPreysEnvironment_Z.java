...
public class ForagingIntensityPreysEnvironment_Z extends Environment {
	...
	public ForagingIntensityPreysEnvironment_Z(Simulator simulator, Arguments arguments) {
